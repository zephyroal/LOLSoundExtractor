...
int xma1_header(FILE *fd, int freq, int chans, int bits, int rawlen, char *seek, int seeklen, int samples) {
    XMAWAVEFORMAT   fmt;
    mywav_chunk     chunk;
...
int xma2_header(FILE *fd, int freq, int chans, int bits, int rawlen, char *seek, int seeklen, int samples) {
...
int xma2xact_header(FILE *fd, int freq, int chans, int bits, int rawlen, char *seek, int seeklen, int samples) {
    XMA2WAVEFORMAT  fmt;
    mywav_chunk     chunk;
